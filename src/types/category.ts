...
export const CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    emoji: '💻',
    keywords: [
      'tech', 'tecnologia', 'tecnologico', 'programming', 'programacion',
      ...
      'ciberseguridad', 'ux', 'ui', 'agile', 'scrum',
      'sql', 'database', 'api', 'apis', 'docker', 'kubernetes',
      'testing', 'qa', 'robotica', 'robotics', 'iot',
      'big data', 'analytics', 'open source',
